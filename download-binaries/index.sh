...
download () {
	...
	curl -f -L -# --compressed -A 'https://github.com/DH-LStudios/ffmpeg-static binaries download script' -o "$2" "$1"
}
...
# todo: 404
download 'https://github.com/GyanD/codexffmpeg/releases/download/7.0/ffmpeg-7.0-full_build.7z' win32-x64.7z
echo '  extracting'
tmpdir=$(mktemp -d)
