...
Supports macOS (64-bit and arm64), Linux (32 and 64-bit, armhf, arm64), Windows (32 and 64-bit). [The ffmpeg version currently used is `7.0`.](https://github.com/DH-LStudios/ffmpeg-static/releases/tag/7.0)
